...
// Nav active state + header opacity on scroll
(function(){
...
// Force dark theme; remove toggle; set header height padding
(function(){
  var html = document.documentElement;
...
// Theme manager: load saved theme (default dark), toggle on click, keep header padding
(function(){
  var key = 'theme';
  var html = document.documentElement;
  var saved = null;
  try { saved = localStorage.getItem(key); } catch(e){}
  var initial = (saved === 'light' || saved === 'dark') ? saved : (html.getAttribute('data-theme') || 'dark');
