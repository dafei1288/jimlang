...
public class JimLangParser extends Parser {
	...
	public static final int
		...
		VAR=10, FUNCTION=11, LET=12, CONST=13, RETURN=14, NEW=15, IF=16, ELSE=17, 
		WHILE=18, FOR=19, BREAK=20, CONTINUE=21, BOOLEAN_LITERAL=22, STRING_LITERAL=23, 
		ML_STRING_LITERAL=24, NUMBER_LITERAL=25, ID=26, WS=27, COMMENT=28, LINE_COMMENT=29, 
		FAC=30, POW=31, MUL=32, DIV=33, ADD=34, SUB=35, DOT=36, LT=37, GT=38, 
		LE=39, GE=40, EQ=41, NE=42, AND=43, OR=44, B_OPEN=45, B_CLOSE=46, S_OPEN=47, 
		S_CLOSE=48, C_OPEN=49, C_CLOSE=50, COMMA=51, SEMI=52, COLON=53, ASSIGN=54;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'float'", "'array'", "'object'", "'var'", "'function'", "'let'", "'const'", 
			"'return'", "'new'", "'if'", "'else'", "'while'", "'for'", "'break'", 
			"'continue'", null, null, null, null, null, null, null, null, "'!'", 
			"'^'", "'*'", "'/'", "'+'", "'-'", "'.'", "'<'", "'>'", "'<='", "'>='", 
			"'=='", "'!='", "'&&'", "'||'", "'('", "')'", "'['", "']'", "'{'", "'}'", 
			"','", "';'", "':'", "'='"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LET", "CONST", "RETURN", "NEW", "IF", "ELSE", "WHILE", "FOR", "BREAK", 
			"CONTINUE", "BOOLEAN_LITERAL", "STRING_LITERAL", "ML_STRING_LITERAL", 
			"NUMBER_LITERAL", "ID", "WS", "COMMENT", "LINE_COMMENT", "FAC", "POW", 
			"MUL", "DIV", "ADD", "SUB", "DOT", "LT", "GT", "LE", "GE", "EQ", "NE", 
			"AND", "OR", "B_OPEN", "B_CLOSE", "S_OPEN", "S_CLOSE", "C_OPEN", "C_CLOSE", 
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 67122176L) != 0)) {
				{
				setState(135);
				forInit();
				}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 738871943888902L) != 0)) {
				{
				setState(139);
				forCondition();
				}
	...
	public final SingleExpressionContext singleExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 35111357644800L) != 0)) {
				{
				{
				setState(174);
				binOP();
	...
	public static class VariableDeclContext extends ParserRuleContext {
		...
		public TerminalNode LET() { return getToken(JimLangParser.LET, 0); }
		public TerminalNode CONST() { return getToken(JimLangParser.CONST, 0); }
	...
	public final BinOPContext binOP() throws RecognitionException {
		...
		try {
			...
			setState(292);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 35111357644800L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
